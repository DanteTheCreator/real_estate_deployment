...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn("p-3 text-black dark:text-white", className)}
      classNames={{
        ...
        day: cn(
          ...
          "h-9 w-9 p-0 font-normal text-black dark:text-white aria-selected:opacity-100 hover:text-accent-foreground"
        ),
